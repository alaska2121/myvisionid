...
# Download model files during build with authentication here ok
RUN curl -L -H "Authorization: Bearer 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" \
    ...
    curl -L -H "Authorization: Bearer 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" \
